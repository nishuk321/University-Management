...
public class Addteacher extends JFrame implements ActionListener{
	...
	long empi=(ran.nextLong(1000)+1000);
	JDateChooser date;
	
	String empid="104"+empi;
	...
	public Addteacher() {
		...
		JLabel heading=new JLabel("New Empolyee Details");
		...
		JLabel labepid=new JLabel("Employee No:");
		labepid.setBounds(50, 175, 200, 25);
		labepid.setFont(new Font("serif", Font.BOLD, 25));
		add(labepid);
		
		
		JLabel textempid=new JLabel(empid);
		textempid.setBounds(230, 175, 150,25);
		textempid.setFont(new Font("serif", Font.BOLD, 25));
		add(textempid);
		...
		JLabel labcourse=new JLabel("Qualification");
		...
		JLabel labbranch=new JLabel("Department");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==submit)
		{
			...
			try {
				  String query = "INSERT INTO facility VALUES('" + rname + "','" + rfather + "','" + employeeid + "','" + dob + "','" + raddress + "','" + remail + "','" + rx + "','" + rx11 + "','" + raddhar + "','" + rcourse + "','" + rbranch + "')";
